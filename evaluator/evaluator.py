...
def evaluate(black_regions_file,currency,root):
    ...
    #black_regions = data.loc[data['is_abnormal'] == 1]
    ...
    #testing
    mask = (black_regions.index >= '2012-01-01') & (black_regions.index <= '2013-01-01')
    black_regions = black_regions.loc[mask]
...
#evaluate("EURUSD2018-03-31 22-49-42.379882.csv","EURUSD","C:/Users/HP/PycharmProjects/black_region_detection_2/")
